...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Luala related functionality
...
/*
    ...
    allow endless transaction that would bloat Luala and make it unusable. To
