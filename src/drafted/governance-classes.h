 ...
 *
 *   // network
 *   CLualaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.luala.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CLualaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: LualaNetwork
// //   -- signature requirements : Key1(User)
// class CLualaNetworkVariable : public CGovernanceObject
// {
// private:
