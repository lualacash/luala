...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "LualaNetwork") type = LualaNetwork;
    if(strType == "LualaNetworkVariable") type = LualaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == LualaNetwork) s = "LualaNetwork";
    if(type == LualaNetworkVariable) s = "LualaNetworkVariable";
