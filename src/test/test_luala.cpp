...
#define BOOST_TEST_MODULE Luala Test Suite

#include "test_luala.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_luala_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
