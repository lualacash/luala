    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Luala Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Luala Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  luala-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Luala in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 LUALA, 0.1 LUALA, 1 LUALA and 10 LUALA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://lualacash.atlassian.net/wiki/display/DOC/PrivateSend\">https://lualacash.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Luala Core is shutting down...") + "<br /><br />" +
