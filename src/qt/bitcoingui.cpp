    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Luala Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Luala address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and luala: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Luala Core"), this);
    aboutAction->setStatusTip(tr("Show information about Luala Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Luala Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Luala addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Luala addresses"));
    ...
    openAction->setStatusTip(tr("Open a luala: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Luala Core help message to get a list with possible Luala Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Luala Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Luala network", "", count));
    } else {
...
{
    QString strTitle = tr("Luala Core"); // default title
