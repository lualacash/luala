    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LUALA-light"), QVariant("light"));
    ui->theme->addItem(QString("LUALA-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("LUALA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LUALA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("LUALA-traditional"), QVariant("trad"));
