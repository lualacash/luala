...
Only requiring some minor changes is luala.cpp.
...
Changes to luala.cpp
----------------------
luala.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
