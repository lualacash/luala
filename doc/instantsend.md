...
This mechanism has been integrated into Bitcore-Node-Luala which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/lualacash/insight-api-luala#web-socket-api](https://github.com/lualacash/insight-api-luala#web-socket-api)
* API: [https://github.com/lualacash/insight-api-luala#instantsend-transactions](https://github.com/lualacash/insight-api-luala#instantsend-transactions)
...
By default, the Luala Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Luala Core daemon:
